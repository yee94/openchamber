...
- Cuando el agente hace una pregunta, el objetivo se pausa automáticamente. El turno actual sigue esperando tu respuesta; cuando contestes, pulsa **Reanudar** para que el bucle continúe.
