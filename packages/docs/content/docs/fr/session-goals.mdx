...
- Quand l'agent pose une question, l'objectif se met automatiquement en pause. Le tour en cours continue d'attendre votre réponse ; une fois que vous avez répondu, appuyez sur **Reprendre** pour relancer la boucle.
