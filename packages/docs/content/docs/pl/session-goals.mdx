...
- Gdy agent zadaje pytanie, cel wstrzymuje się automatycznie. Bieżąca tura nadal czeka na twoją odpowiedź; po odpowiedzi naciśnij **Wznów**, aby pętla ruszyła dalej.
