...
- Quando o agente faz uma pergunta, o objetivo pausa automaticamente. O turno atual continua esperando a sua resposta; depois de responder, pressione **Retomar** para o loop seguir.
