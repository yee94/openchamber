---
title: MCP Servers
description: 添加 MCP 服务器，为 Agent 提供额外工具。
---

# MCP Servers

MCP 服务器为你的 Agent 提供额外的工具 — 比如搜索数据库、调用 API，或读取你使用的某个服务。在 **Settings → MCP** 中添加它们。
...
- [提供商、模型与 Agent](/zh-cn/providers/) — 先连接一个模型
- [Skills](/zh-cn/skills/) — 另一种扩展 Agent 能力的方式
