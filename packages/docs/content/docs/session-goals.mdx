...
- When the agent asks a question, the goal pauses automatically. The current turn keeps waiting for your answer; after you reply, press **Resume** to continue the loop.
