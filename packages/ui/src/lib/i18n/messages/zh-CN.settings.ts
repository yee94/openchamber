...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'assistants.empty': '请先在设置中创建助理。',
  'assistants.actions.retry': '重试',
  'assistants.actions.backToChat': '返回聊天',
  'assistants.actions.backToAssistants': '返回助理列表',
  'assistants.actions.backToTopics': '返回主题列表',
  ...
  'assistants.topics.inbox': '收件箱',
  'assistants.topics.create': '新建主题',
  'assistants.topics.rename': '重命名主题',
  'assistants.topics.archive': '归档主题',
  'assistants.topics.newPlaceholder': '新主题',
  'assistants.topics.renamePlaceholder': '主题名称',
  'assistants.topics.actionFailed': '无法更新主题。',
  'assistants.conversation.continuousHint': '一段持续的长对话',
  'assistants.conversation.statelessHint': '每轮独立执行的一段长对话',
  'assistants.conversation.you': '你',
  'assistants.conversation.emptyTitle': '开始与 {name} 对话',
  'assistants.conversation.emptyDescription': '此主题中的消息会汇集在一起。',
  ...
  'assistants.settings.description': '配置此 OpenChamber 实例中的常驻助理。',
  'assistants.settings.instanceEnabled': '在此实例中启用助理',
  'assistants.settings.listTitle': '助理',
  'assistants.settings.create': '新建助理',
  'assistants.settings.delete': '删除',
  'assistants.settings.deleteConfirm': '删除 {name}？其主题和对话记录将被归档。',
  ...
  'assistants.settings.paths': '工作区与技能',
  'assistants.settings.workspace': '工作区',
  'assistants.settings.workspacePlaceholder': '托管工作区',
  'assistants.settings.skillRoots': '技能根目录',
  'assistants.settings.skillRootPlaceholder': '/技能/目录/路径',
  'assistants.settings.addPath': '添加',
  'assistants.settings.removePath': '移除 {path}',
