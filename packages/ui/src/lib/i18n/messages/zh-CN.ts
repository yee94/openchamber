...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.scheduledTasks.workspace.search.placeholder': '搜索任务…',
  'sessions.scheduledTasks.workspace.search.noResults': '没有符合搜索条件的任务。',
  'sessions.scheduledTasks.workspace.partialLoadWarning': '部分项目的计划任务加载失败，已加载的任务仍可使用。',
  'sessions.scheduledTasks.workspace.editor.emptyTitle': '选择任务',
  'sessions.scheduledTasks.workspace.editor.emptyDescription': '从列表中选择任务，或创建新任务。',
