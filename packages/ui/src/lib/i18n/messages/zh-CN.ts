...
export const dict: Record<I18nKey, string> = {
  ...
  'files.tree.status.modified': '已修改',
  'files.tree.status.added': '新增',
  'files.tree.status.untracked': '未跟踪',
  'files.tree.status.deleted': '已删除',
  'files.tree.status.renamed': '已重命名',
  'files.tree.status.copied': '已复制',
  'filesView.navigation.definitionNotFound': '找不到 {name} 的定义',
