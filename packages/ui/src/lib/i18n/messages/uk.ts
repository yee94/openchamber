...
export const dict: Record<I18nKey, string> = {
  ...
  "files.tree.status.modified": "Змінено",
  "files.tree.status.added": "Додано",
  "files.tree.status.untracked": "Не відстежується",
  "files.tree.status.deleted": "Видалено",
  "files.tree.status.renamed": "Перейменовано",
  "files.tree.status.copied": "Скопійовано",
  "filesView.navigation.definitionNotFound": "Не знайдено визначення для {name}",
