...
export const dict: Record<I18nKey, string> = {
  ...
  'files.tree.status.modified': 'Zmodyfikowany',
  'files.tree.status.added': 'Dodany',
  'files.tree.status.untracked': 'Nieśledzony',
  'files.tree.status.deleted': 'Usunięty',
  'files.tree.status.renamed': 'Zmieniona nazwa',
  'files.tree.status.copied': 'Skopiowany',
  'filesView.navigation.definitionNotFound': 'Nie znaleziono definicji {name}',
