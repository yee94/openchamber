...
export const dict: Record<I18nKey, string> = {
  ...
  "files.tree.status.added": "Añadido",
  "files.tree.status.untracked": "Sin seguimiento",
  "files.tree.status.deleted": "Eliminado",
  "files.tree.status.renamed": "Renombrado",
  "files.tree.status.copied": "Copiado",
  "filesView.navigation.definitionNotFound": "No se encontró la definición de {name}",
