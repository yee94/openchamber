export const settingsDict = {
  ...
  'assistants.contact.placeholder': 'Message {name}… /card <sessionID> [title] or /dm <assistantID> <text>',
  'assistants.contact.composerHint': 'Card: /card <sessionID> [title]. Message another assistant: /dm <assistantID> <text>.',
  ...
  'assistants.contact.card.session.open': 'Open session',
  'assistants.contact.card.session.aria': 'Open session {title}',
