export const settingsDict = {
  ...
  'settings.openchamber.visual.field.sidebarBrandHint': 'Enter the full sidebar logo text. The final space-separated word uses the accent color.',
  ...
  'settings.openchamber.visual.field.showSplitAssistantMessageActionsTooltip': 'Show Copy Answer and Read aloud on assistant text blocks that appear before later tool calls in the same response.',
