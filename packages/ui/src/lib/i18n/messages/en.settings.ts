export const settingsDict = {
  ...
  'assistants.empty': 'Create an assistant in Settings to get started.',
  'assistants.actions.retry': 'Try again',
  'assistants.actions.backToChat': 'Back to chat',
  'assistants.actions.backToAssistants': 'Back to assistants',
  'assistants.actions.backToTopics': 'Back to topics',
  ...
  'assistants.topics.inbox': 'Inbox',
  'assistants.topics.create': 'Create topic',
  'assistants.topics.rename': 'Rename topic',
  'assistants.topics.archive': 'Archive topic',
  'assistants.topics.newPlaceholder': 'New topic',
  'assistants.topics.renamePlaceholder': 'Topic name',
  'assistants.topics.actionFailed': 'The topic could not be updated.',
  'assistants.conversation.continuousHint': 'One continuous conversation',
  'assistants.conversation.statelessHint': 'One conversation with fresh execution each turn',
  'assistants.conversation.you': 'You',
  'assistants.conversation.emptyTitle': 'Start a conversation with {name}',
  'assistants.conversation.emptyDescription': 'Messages stay together in this topic.',
  ...
  'assistants.settings.description': 'Configure persistent assistants for this OpenChamber instance.',
  'assistants.settings.instanceEnabled': 'Enable assistants on this instance',
  'assistants.settings.listTitle': 'Assistants',
  'assistants.settings.create': 'New assistant',
  'assistants.settings.delete': 'Delete',
  'assistants.settings.deleteConfirm': 'Delete {name}? Its topics and conversation history will be archived.',
  ...
  'assistants.settings.paths': 'Workspace and skills',
  'assistants.settings.workspace': 'Workspace',
  'assistants.settings.workspacePlaceholder': 'Managed workspace',
  'assistants.settings.skillRoots': 'Skill roots',
  'assistants.settings.skillRootPlaceholder': '/path/to/skills',
  'assistants.settings.addPath': 'Add',
  'assistants.settings.removePath': 'Remove {path}',
