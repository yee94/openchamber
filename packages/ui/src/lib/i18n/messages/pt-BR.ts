...
export const dict: Record<I18nKey, string> = {
 ...settingsDict,
  ...
  "files.tree.status.modified": "Modificado",
  "files.tree.status.added": "Adicionado",
  "files.tree.status.untracked": "Não rastreado",
  "files.tree.status.deleted": "Excluído",
  "files.tree.status.renamed": "Renomeado",
  "files.tree.status.copied": "Copiado",
  "filesView.navigation.definitionNotFound": "Nenhuma definição encontrada para {name}",
