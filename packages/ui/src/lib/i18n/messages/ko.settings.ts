...
'settings.openchamber.keyboardShortcuts.action.clear_all_messages.label': '모든 메시지 지우기',
  ...
  'assistants.empty': '설정에서 어시스턴트를 만들어 시작하세요.',
  'assistants.actions.retry': '다시 시도',
  'assistants.actions.backToChat': '채팅으로 돌아가기',
  'assistants.actions.backToAssistants': '어시스턴트 목록으로 돌아가기',
  'assistants.actions.backToTopics': '주제 목록으로 돌아가기',
  ...
  'assistants.topics.inbox': '받은 편지함',
  'assistants.topics.create': '주제 만들기',
  'assistants.topics.rename': '주제 이름 바꾸기',
  'assistants.topics.archive': '주제 보관',
  'assistants.topics.newPlaceholder': '새 주제',
  'assistants.topics.renamePlaceholder': '주제 이름',
  'assistants.topics.actionFailed': '주제를 업데이트할 수 없습니다.',
  'assistants.conversation.continuousHint': '하나의 연속 대화',
  'assistants.conversation.statelessHint': '매 턴 새로 실행되는 하나의 대화',
  'assistants.conversation.you': '나',
  'assistants.conversation.emptyTitle': '{name}님과 대화 시작',
  'assistants.conversation.emptyDescription': '이 주제의 메시지는 한곳에 모입니다.',
  ...
  'assistants.settings.description': '이 OpenChamber 인스턴스의 상시 어시스턴트를 설정합니다.',
  'assistants.settings.instanceEnabled': '이 인스턴스에서 어시스턴트 활성화',
  'assistants.settings.listTitle': '어시스턴트',
  'assistants.settings.create': '새 어시스턴트',
  'assistants.settings.delete': '삭제',
  'assistants.settings.deleteConfirm': '{name}을(를) 삭제할까요? 주제와 대화 기록이 보관됩니다.',
  ...
  'assistants.settings.paths': '작업 공간 및 스킬',
  'assistants.settings.workspace': '작업 공간',
  'assistants.settings.workspacePlaceholder': '관리형 작업 공간',
  'assistants.settings.skillRoots': '스킬 루트',
  'assistants.settings.skillRootPlaceholder': '/스킬/경로',
  'assistants.settings.addPath': '추가',
  'assistants.settings.removePath': '{path} 제거',
