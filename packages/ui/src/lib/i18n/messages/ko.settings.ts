export const settingsDict = {
  ...
  'settings.openchamber.visual.field.codeFontSize': '코드 글꼴 크기',
  'settings.openchamber.visual.field.codeFontSizePercentageAria': '코드 글꼴 크기 비율',
  'settings.openchamber.visual.actions.resetCodeFontSizeAria': '코드 글꼴 크기 재설정',
