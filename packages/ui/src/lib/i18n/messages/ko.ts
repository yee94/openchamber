...
export const dict: Record<I18nKey, string> = {
  ...
  'files.tree.status.modified': '수정됨',
  'files.tree.status.added': '추가됨',
  'files.tree.status.untracked': '추적되지 않음',
  'files.tree.status.deleted': '삭제됨',
  'files.tree.status.renamed': '이름 변경됨',
  'files.tree.status.copied': '복사됨',
  'filesView.navigation.definitionNotFound': '{name}의 정의를 찾을 수 없습니다',
