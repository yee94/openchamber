...
export const dict = {
  ...
  'files.tree.status.modified': 'Modified',
  'files.tree.status.added': 'Added',
  'files.tree.status.untracked': 'Untracked',
  'files.tree.status.deleted': 'Deleted',
  'files.tree.status.renamed': 'Renamed',
  'files.tree.status.copied': 'Copied',
  'filesView.navigation.definitionNotFound': 'No definition found for {name}',
