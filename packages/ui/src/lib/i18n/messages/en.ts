...
export const dict = {
  ...
  'sessions.scheduledTasks.workspace.search.placeholder': 'Search tasks…',
  'sessions.scheduledTasks.workspace.search.noResults': 'No tasks match your search.',
  'sessions.scheduledTasks.workspace.partialLoadWarning': 'Some projects could not load scheduled tasks. Loaded tasks remain available.',
  'sessions.scheduledTasks.workspace.editor.emptyTitle': 'Select a task',
  'sessions.scheduledTasks.workspace.editor.emptyDescription': 'Choose a task from the list or create a new one.',
