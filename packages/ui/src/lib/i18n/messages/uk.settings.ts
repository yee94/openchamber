...
"settings.openchamber.keyboardShortcuts.action.clear_all_messages.label": "Очистити всі повідомлення",
  ...
  'assistants.empty': 'Створіть асистента в Налаштуваннях, щоб почати.',
  'assistants.actions.retry': 'Спробувати ще раз',
  'assistants.actions.backToChat': 'Назад до чату',
  'assistants.actions.backToAssistants': 'Назад до асистентів',
  'assistants.actions.backToTopics': 'Назад до тем',
  ...
  'assistants.topics.inbox': 'Вхідні',
  'assistants.topics.create': 'Створити тему',
  'assistants.topics.rename': 'Перейменувати тему',
  'assistants.topics.archive': 'Архівувати тему',
  'assistants.topics.newPlaceholder': 'Нова тема',
  'assistants.topics.renamePlaceholder': 'Назва теми',
  'assistants.topics.actionFailed': 'Не вдалося оновити тему.',
  'assistants.conversation.continuousHint': 'Одна безперервна розмова',
  'assistants.conversation.statelessHint': 'Одна розмова з новим виконанням на кожному кроці',
  'assistants.conversation.you': 'Ви',
  'assistants.conversation.emptyTitle': 'Почніть розмову з {name}',
  'assistants.conversation.emptyDescription': 'Повідомлення зберігаються разом у цій темі.',
  ...
  'assistants.settings.description': 'Налаштуйте постійних асистентів для цього екземпляра OpenChamber.',
  'assistants.settings.instanceEnabled': 'Увімкнути асистентів у цьому екземплярі',
  'assistants.settings.listTitle': 'Асистенти',
  'assistants.settings.create': 'Новий асистент',
  'assistants.settings.delete': 'Видалити',
  'assistants.settings.deleteConfirm': 'Видалити {name}? Теми та історію розмов буде архівовано.',
  ...
  'assistants.settings.paths': 'Робочий простір і навички',
  'assistants.settings.workspace': 'Робочий простір',
  'assistants.settings.workspacePlaceholder': 'Керований робочий простір',
  'assistants.settings.skillRoots': 'Кореневі каталоги навичок',
  'assistants.settings.skillRootPlaceholder': '/шлях/до/навичок',
  'assistants.settings.addPath': 'Додати',
  'assistants.settings.removePath': 'Видалити {path}',
