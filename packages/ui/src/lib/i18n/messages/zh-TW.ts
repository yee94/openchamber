...
export const dict: Record<I18nKey, string> = {
  ...
  'files.tree.status.untracked': '未追蹤',
  'files.tree.status.deleted': '已刪除',
  'files.tree.status.renamed': '已重新命名',
  'files.tree.status.copied': '已複製',
  'filesView.navigation.definitionNotFound': '找不到 {name} 的定義',
