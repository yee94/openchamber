...
'settings.openchamber.keyboardShortcuts.action.clear_all_messages.label': 'Wyczyść wszystkie wiadomości',
  ...
  'assistants.empty': 'Utwórz asystenta w Ustawieniach, aby rozpocząć.',
  'assistants.actions.retry': 'Spróbuj ponownie',
  'assistants.actions.backToChat': 'Wróć do czatu',
  'assistants.actions.backToAssistants': 'Wróć do asystentów',
  'assistants.actions.backToTopics': 'Wróć do tematów',
  ...
  'assistants.topics.inbox': 'Skrzynka odbiorcza',
  'assistants.topics.create': 'Utwórz temat',
  'assistants.topics.rename': 'Zmień nazwę tematu',
  'assistants.topics.archive': 'Archiwizuj temat',
  'assistants.topics.newPlaceholder': 'Nowy temat',
  'assistants.topics.renamePlaceholder': 'Nazwa tematu',
  'assistants.topics.actionFailed': 'Nie udało się zaktualizować tematu.',
  'assistants.conversation.continuousHint': 'Jedna ciągła rozmowa',
  'assistants.conversation.statelessHint': 'Jedna rozmowa z nowym wykonaniem w każdej turze',
  'assistants.conversation.you': 'Ty',
  'assistants.conversation.emptyTitle': 'Rozpocznij rozmowę z {name}',
  'assistants.conversation.emptyDescription': 'Wiadomości pozostają razem w tym temacie.',
  ...
  'assistants.settings.description': 'Skonfiguruj stałych asystentów dla tej instancji OpenChamber.',
  'assistants.settings.instanceEnabled': 'Włącz asystentów w tej instancji',
  'assistants.settings.listTitle': 'Asystenci',
  'assistants.settings.create': 'Nowy asystent',
  'assistants.settings.delete': 'Usuń',
  'assistants.settings.deleteConfirm': 'Usunąć {name}? Tematy i historia rozmów zostaną zarchiwizowane.',
  ...
  'assistants.settings.paths': 'Obszar roboczy i umiejętności',
  'assistants.settings.workspace': 'Obszar roboczy',
  'assistants.settings.workspacePlaceholder': 'Zarządzany obszar roboczy',
  'assistants.settings.skillRoots': 'Katalogi główne umiejętności',
  'assistants.settings.skillRootPlaceholder': '/ścieżka/do/umiejętności',
  'assistants.settings.addPath': 'Dodaj',
  'assistants.settings.removePath': 'Usuń {path}',
