...
const TARGETS: Array<{ id: ConfigTarget; label: string }> = [
  { id: 'opencode', label: 'OpenCode' },
  { id: 'oh-my-opencode-slim', label: 'oh-my-opencode-slim' },
  { id: 'oh-my-openagent', label: 'oh-my-openagent' },
];
...
export function GlobalConfigPage() {
  ...
  const [target, setTarget] = React.useState<ConfigTarget>('opencode');
  ...
  const editorExtensions = React.useMemo<Extension[]>(() => {
    const editorFileName = fileName || 'opencode.jsonc';
