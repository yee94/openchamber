...
| Scheduled | Airy title/meta, small status glyphs, small `+` | Title 16 / 0.65 / 1.4. Meta 13 / 0.5 / 1.65 with 8px gap. Status circle 18 / glyph 8. `+` 28 ink. | Create-task `+` is chrome-only. Overflow `...` still calls run-now. |
