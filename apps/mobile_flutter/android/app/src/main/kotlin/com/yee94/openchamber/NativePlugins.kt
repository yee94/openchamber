...
object NativePlugins {
    ...
    fun register(engine: FlutterEngine, activity: MainActivity) {
        ...
        // FCM notification taps land as Activity intent extras. Do not call
        // FirebaseMessaging.getInitialMessage — that is FlutterFire Dart, not
        // firebase-messaging 24.x, and it fails :app:compileDebugKotlin.
