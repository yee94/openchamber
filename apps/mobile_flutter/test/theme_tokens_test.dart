...
void main() {
  ...
  test('OcOptical sizes are smaller/airier than the previous crude chrome', () {
    ...
    expect(OcOptical.rowTitle, 13);
    expect(OcOptical.rowTitleTracking, greaterThan(0.4));
    expect(OcOptical.rowTitleHeight, lessThan(1.5));
    expect(OcOptical.sessionRowPadV, greaterThanOrEqualTo(8));
    expect(OcOptical.sessionRowPadV, lessThan(13));
    expect(OcOptical.metaHeight, greaterThanOrEqualTo(1.3));
    expect(OcOptical.entityTitleHeight, lessThan(1.4));
    expect(OcOptical.scheduleTitleMetaGap, greaterThanOrEqualTo(6));
    ...
    expect(OcOptical.dockIconPillHeight, 18);
    ...
    expect(OcOptical.dockGlyphStroke, lessThan(0.42));
    expect(OcOptical.listGlyphStroke, lessThan(OcOptical.headerGlyphStroke));
    expect(OcOptical.leadingCircle, 9);
    expect(OcOptical.footerGlyph, 6);
    expect(OcOptical.scheduleStatus, 9);
    expect(OcOptical.sessionBullet, 2);
    expect(OcOptical.fileTypeW, 8);
    expect(OcOptical.fileRowPadV, lessThan(8));
    expect(OcOptical.composerRadius, 26);
