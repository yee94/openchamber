...
void main() {
  ...
  test('OcOptical sizes are smaller/airier than the previous crude chrome', () {
    ...
    expect(OcOptical.sessionRowVisualHeight, closeTo(102.8, 0.01));
    ...
    expect(OcOptical.groupTitleMetaGap, 42);
    ...
    expect(OcOptical.sessionTitleSubtitleGap, 46);
    ...
    expect(OcOptical.scheduleTitleMetaGap, 42);
  ...
  test('OcElevation ports official float-shadow and chip near-pair lift', () {
    ...
    expect(OcElevation.cardFor(OcTokens.light).last.blurRadius, 144);
    expect(OcElevation.cardFor(OcTokens.light).last.offset.dy, 10);
    expect(OcElevation.cardFor(OcTokens.light).last.spreadRadius, -36);
    expect(
