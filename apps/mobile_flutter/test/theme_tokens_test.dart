...
void main() {
  ...
  test('OcOptical sizes are smaller/airier than the previous crude chrome', () {
    ...
    expect(OcOptical.sessionTitleSubtitleGap, 22);
    ...
    expect(OcOptical.scheduleTitleMetaGap, 18);
    ...
    expect(OcOptical.scheduleStatusVisual, 8);
    expect(OcOptical.scheduleStatusGlyph, 3);
  ...
  test('OcElevation ports official float-shadow and chip near-pair lift', () {
    ...
    expect(OcElevation.cardFor(OcTokens.light).last.blurRadius, 48);
    expect(OcElevation.cardFor(OcTokens.light).last.offset.dy, 10);
    expect(OcElevation.cardFor(OcTokens.light).last.spreadRadius, -12);
    expect(
