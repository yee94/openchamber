...
void main() {
  ...
  test('OcOptical sizes are smaller/airier than the previous crude chrome', () {
    ...
    expect(OcOptical.sessionTitleSubtitleGap, 30);
    ...
    expect(OcOptical.scheduleTitleMetaGap, 26);
    ...
    expect(OcOptical.headerGlyph, 5);
    ...
    expect(OcOptical.scheduleStatusVisual, 4);
  ...
  test('OcElevation ports official float-shadow and chip near-pair lift', () {
    ...
    expect(OcElevation.cardFor(OcTokens.light).last.blurRadius, 80);
    expect(OcElevation.cardFor(OcTokens.light).last.offset.dy, 10);
    expect(OcElevation.cardFor(OcTokens.light).last.spreadRadius, -20);
    expect(
