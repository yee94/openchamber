...
void main() {
  ...
  test('OcOptical sizes are smaller/airier than the previous crude chrome', () {
    ...
    expect(OcOptical.headerGlyphStrokeVisual, lessThan(OcOptical.dockGlyphStrokeVisual));
    ...
    expect(OcOptical.dockGlyphStrokeVisual, closeTo(1.25, 0.01));
    expect(OcOptical.dockGlyphStrokeVisual, greaterThanOrEqualTo(0.9));
    expect(OcOptical.dockGlyphStrokeVisual, isNot(0.12));
    expect(OcOptical.dockStrokeGlyphStrokeVisual, closeTo(1.25, 0.01));
    expect(OcOptical.dockStrokeGlyphStrokeVisual, OcOptical.dockGlyphStrokeVisual);
    expect(OcOptical.dockGlyphVisual, 23);
    expect(OcOptical.dockIconWashAlpha, closeTo(0.55, 0.01));
    ...
    expect(OcOptical.scheduleStatusGlyphStroke, greaterThan(OcOptical.headerGlyphStrokeVisual));
    ...
    expect(OcOptical.fileTypeStrokeVisual, closeTo(1.0, 0.01));
    expect(OcOptical.fileTypeStrokeVisual, isNot(OcOptical.dockGlyphStrokeVisual));
    ...
    expect(OcOptical.footerGlyphStrokeVisual, closeTo(1.0, 0.01));
    expect(OcOptical.footerGlyphStrokeVisual, lessThan(OcOptical.footerGlyphStroke));
    expect(OcOptical.footerGlyphStrokeVisual, isNot(0.12));
    ...
    expect(OcOptical.settingsGlyphStrokeVisual, closeTo(1.25, 0.01));
    expect(OcOptical.settingsGlyphStrokeVisual, greaterThanOrEqualTo(1.0));
    expect(OcOptical.settingsGlyphStrokeVisual, isNot(0.12));
    expect(OcOptical.settingsChevronStrokeVisual, closeTo(1.0, 0.01));
    expect(OcOptical.settingsChevronStrokeVisual, lessThan(OcOptical.settingsGlyphStrokeVisual));
