...
void main() {
  ...
  test('OcOptical sizes are smaller/airier than the previous crude chrome', () {
    ...
    expect(OcOptical.sessionRowVisualHeight, closeTo(112.8, 0.01));
    ...
    expect(OcOptical.groupTitleMetaGap, 52);
    ...
    expect(OcOptical.sessionTitleSubtitleGap, 56);
    ...
    expect(OcOptical.scheduleTitleMetaGap, 52);
  ...
  test('OcElevation ports official float-shadow and chip near-pair lift', () {
    ...
    expect(OcElevation.cardFor(OcTokens.light).last.blurRadius, 184);
    expect(OcElevation.cardFor(OcTokens.light).last.offset.dy, 10);
    expect(OcElevation.cardFor(OcTokens.light).last.spreadRadius, -46);
    expect(
