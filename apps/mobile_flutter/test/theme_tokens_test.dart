...
void main() {
  ...
  test('OcOptical sizes are smaller/airier than the previous crude chrome', () {
    ...
    expect(OcOptical.rowTitleHeight, greaterThan(1.72));
    ...
    expect(OcOptical.headerDisc, 26);
    expect(OcOptical.headerDisc, lessThan(OcOptical.searchButton));
    expect(OcOptical.headerDisc, greaterThan(22));
    ...
    expect(OcOptical.dockIconWashAlpha, lessThan(0.12));
    ...
    expect(OcOptical.fileRowPadV, greaterThanOrEqualTo(8));
  ...
  test('OcElevation is layered in light and empty in dark', () {
    ...
    expect(OcElevation.cardFor(OcTokens.light).last.offset.dy, greaterThanOrEqualTo(8));
    expect(
