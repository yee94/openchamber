...
void main() {
  ...
  test('OcOptical sizes are smaller/airier than the previous crude chrome', () {
    ...
    expect(OcOptical.sessionRowVisualHeight, closeTo(64.8, 0.01));
    expect(OcOptical.sessionRowVisualHeight, greaterThanOrEqualTo(40));
    expect(OcOptical.sessionRowVisualHeight, lessThan(66));
    ...
    expect(OcOptical.sessionTitleSubtitleGap, 8);
    ...
    expect(OcOptical.headerGlyphStrokeVisual, closeTo(0.24, 0.01));
    ...
    expect(OcOptical.dockGlyphStrokeVisual, closeTo(0.24, 0.01));
    expect(OcOptical.dockGlyphStrokeVisual, lessThan(0.44));
    expect(OcOptical.dockStrokeGlyphStrokeVisual, closeTo(0.24, 0.01));
    expect(OcOptical.dockStrokeGlyphStrokeVisual, lessThanOrEqualTo(OcOptical.dockGlyphStrokeVisual));
    expect(OcOptical.dockStrokeGlyphStrokeVisual, greaterThan(0.20));
    ...
    expect(OcOptical.fileTypeStrokeVisual, closeTo(0.24, 0.01));
    ...
    expect(OcOptical.footerGlyphStrokeVisual, closeTo(0.24, 0.01));
