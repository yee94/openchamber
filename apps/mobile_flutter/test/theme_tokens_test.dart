...
void main() {
  ...
  test('OcOptical sizes are smaller/airier than the previous crude chrome', () {
    ...
    expect(OcOptical.sessionTitleSubtitleGap, 24);
    ...
    expect(OcOptical.scheduleTitleMetaGap, 20);
    ...
    expect(OcOptical.scheduleStatusVisual, 6);
    expect(OcOptical.scheduleStatusGlyph, 2);
  ...
  test('OcElevation ports official float-shadow and chip near-pair lift', () {
    ...
    expect(OcElevation.cardFor(OcTokens.light).last.blurRadius, 56);
    expect(OcElevation.cardFor(OcTokens.light).last.offset.dy, 10);
    expect(OcElevation.cardFor(OcTokens.light).last.spreadRadius, -14);
    expect(
