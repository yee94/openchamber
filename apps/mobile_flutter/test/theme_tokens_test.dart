...
void main() {
  ...
  test('OcTokens light and dark follow design-system.css OKLCH, not iOS greys', () {
    ...
    expect(OcTokens.light.glassChipFill.a, closeTo(0.30, 0.01));
    expect(OcTokens.light.glassChipFill.a, lessThan(OcTokens.light.glassFill.a));
    expect(OcTokens.dark.glassChipFill.a, closeTo(0.30, 0.01));
  ...
  test('OcOptical sizes are smaller/airier than the previous crude chrome', () {
    ...
    expect(OcOptical.dockGlyphStrokeVisual, closeTo(1.02, 0.01));
    expect(OcOptical.dockGlyphStrokeVisual, greaterThan(1.00));
    expect(OcOptical.dockStrokeGlyphStrokeVisual, closeTo(0.94, 0.01));
    expect(OcOptical.dockStrokeGlyphStrokeVisual, lessThan(OcOptical.dockGlyphStrokeVisual));
    expect(OcOptical.dockStrokeGlyphStrokeVisual, greaterThan(0.90));
