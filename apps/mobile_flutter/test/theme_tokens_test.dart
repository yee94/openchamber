...
void main() {
  ...
  test('OcOptical sizes are smaller/airier than the previous crude chrome', () {
    ...
    expect(OcOptical.sessionRowVisualHeight, closeTo(92.8, 0.01));
    ...
    expect(OcOptical.groupTitleMetaGap, 32);
    ...
    expect(OcOptical.scheduleTitleMetaGap, 32);
    ...
    expect(OcOptical.leadingCircleVisual, 4);
  ...
  test('OcElevation ports official float-shadow and chip near-pair lift', () {
    ...
    expect(OcElevation.cardFor(OcTokens.light).last.blurRadius, 104);
    expect(OcElevation.cardFor(OcTokens.light).last.offset.dy, 10);
    expect(OcElevation.cardFor(OcTokens.light).last.spreadRadius, -26);
    expect(
