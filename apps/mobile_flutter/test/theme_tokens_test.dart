...
void main() {
  ...
  test('OcOptical sizes are smaller/airier than the previous crude chrome', () {
    ...
    expect(OcOptical.sessionTitleStem, closeTo(1.05, 0.01));
    ...
    expect(OcOptical.cssLineCjkHalfLead, greaterThan(3.5));
    ...
    expect(OcOptical.scheduleStatusGlyph, 10);
    ...
    expect(OcOptical.footerGlyphStrokeVisual, closeTo(0.44, 0.01));
