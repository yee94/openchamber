...
void main() {
  ...
  test('OcOptical sizes are smaller/airier than the previous crude chrome', () {
    ...
    expect(OcOptical.sessionTitleSubtitleGap, 20);
    ...
    expect(OcOptical.scheduleTitleMetaGap, 16);
    ...
    expect(OcOptical.scheduleStatusVisual, 10);
    expect(OcOptical.scheduleStatusGlyph, 4);
  ...
  test('OcElevation ports official float-shadow and chip near-pair lift', () {
    ...
    expect(OcElevation.cardFor(OcTokens.light).last.blurRadius, 40);
    expect(OcElevation.cardFor(OcTokens.light).last.offset.dy, 10);
    expect(OcElevation.cardFor(OcTokens.light).last.spreadRadius, -10);
    expect(
