...
void main() {
  ...
  test('OcOptical sizes are smaller/airier than the previous crude chrome', () {
    ...
    expect(OcOptical.sessionRowVisualHeight, closeTo(108.8, 0.01));
    ...
    expect(OcOptical.groupTitleMetaGap, 48);
    ...
    expect(OcOptical.sessionTitleSubtitleGap, 52);
    ...
    expect(OcOptical.scheduleTitleMetaGap, 48);
    ...
    expect(OcOptical.leadingCircleVisual, 2);
    expect(OcOptical.leadingCircleCompact, 2);
    expect(OcOptical.leadingCircleVisual, lessThan(OcOptical.leadingCircle));
    expect(OcOptical.leadingGlyph, 18);
    expect(OcOptical.leadingGlyphVisual, 1);
    ...
    expect(OcOptical.scheduleStatusVisual, 2);
    expect(OcOptical.scheduleStatusGlyph, 1);
  ...
  test('OcElevation ports official float-shadow and chip near-pair lift', () {
    ...
    expect(OcElevation.cardFor(OcTokens.light).last.blurRadius, 168);
    expect(OcElevation.cardFor(OcTokens.light).last.offset.dy, 10);
    expect(OcElevation.cardFor(OcTokens.light).last.spreadRadius, -42);
    expect(
