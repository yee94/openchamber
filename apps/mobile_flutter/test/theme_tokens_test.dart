...
void main() {
  ...
  test('OcOptical sizes are smaller/airier than the previous crude chrome', () {
    ...
    expect(OcOptical.sessionRowVisualHeight, 42);
    ...
    expect(OcOptical.dockGlyphStrokeVisual, closeTo(0.96, 0.01));
    expect(OcOptical.dockGlyphStrokeVisual, greaterThan(0.90));
    expect(OcOptical.dockStrokeGlyphStrokeVisual, closeTo(0.88, 0.01));
    expect(OcOptical.dockStrokeGlyphStrokeVisual, lessThan(OcOptical.dockGlyphStrokeVisual));
    expect(OcOptical.dockStrokeGlyphStrokeVisual, greaterThan(0.80));
