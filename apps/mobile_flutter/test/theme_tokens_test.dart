...
void main() {
  ...
  test('OcOptical sizes are smaller/airier than the previous crude chrome', () {
    ...
    expect(OcOptical.sessionRowVisualHeight, closeTo(100.8, 0.01));
    ...
    expect(OcOptical.groupTitleMetaGap, 40);
    ...
    expect(OcOptical.sessionTitleSubtitleGap, 44);
    ...
    expect(OcOptical.scheduleTitleMetaGap, 40);
  ...
  test('OcElevation ports official float-shadow and chip near-pair lift', () {
    ...
    expect(OcElevation.cardFor(OcTokens.light).last.blurRadius, 136);
    expect(OcElevation.cardFor(OcTokens.light).last.offset.dy, 10);
    expect(OcElevation.cardFor(OcTokens.light).last.spreadRadius, -34);
    expect(
