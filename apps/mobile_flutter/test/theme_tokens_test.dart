...
void main() {
  ...
  test('OcOptical sizes are smaller/airier than the previous crude chrome', () {
    ...
    expect(OcOptical.sessionRowVisualHeight, closeTo(94.8, 0.01));
    ...
    expect(OcOptical.groupTitleMetaGap, 34);
    ...
    expect(OcOptical.sessionTitleSubtitleGap, 38);
    ...
    expect(OcOptical.scheduleTitleMetaGap, 34);
    ...
    expect(OcOptical.leadingGlyphVisual, 2);
  ...
  test('OcElevation ports official float-shadow and chip near-pair lift', () {
    ...
    expect(OcElevation.cardFor(OcTokens.light).last.blurRadius, 112);
    expect(OcElevation.cardFor(OcTokens.light).last.offset.dy, 10);
    expect(OcElevation.cardFor(OcTokens.light).last.spreadRadius, -28);
    expect(
