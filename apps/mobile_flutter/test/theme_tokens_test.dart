...
void main() {
  ...
  test('OcOptical sizes are smaller/airier than the previous crude chrome', () {
    ...
    expect(OcOptical.sessionRowVisualHeight, closeTo(110.8, 0.01));
    ...
    expect(OcOptical.groupTitleMetaGap, 50);
    ...
    expect(OcOptical.sessionTitleSubtitleGap, 54);
    ...
    expect(OcOptical.scheduleTitleMetaGap, 50);
  ...
  test('OcElevation ports official float-shadow and chip near-pair lift', () {
    ...
    expect(OcElevation.cardFor(OcTokens.light).last.blurRadius, 176);
    expect(OcElevation.cardFor(OcTokens.light).last.offset.dy, 10);
    expect(OcElevation.cardFor(OcTokens.light).last.spreadRadius, -44);
    expect(
