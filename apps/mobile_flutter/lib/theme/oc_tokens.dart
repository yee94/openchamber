...
class OcTokens extends ThemeExtension<OcTokens> {
  ...
  /// without blur is a coin. Contact rim + OcElevation.chip restore
  /// chip presence without a cream plate (wake-0741).
  ...
  /// token, mix-only — no RGB@0.55, no nested frost (wake-0741).
