...
/// [OcOptical.cssLineCjkHalfLead] is 4.6 Flutter pixels unless a face needs more.
...
class OcCssLine extends StatelessWidget {
  ...
  final bool expand;
  /// Default is [OcOptical.cssLineCjkHalfLead] (4.6). The 56px chat
...
class GroupedInsetCard extends StatelessWidget {
  ...
  /// official float-shadow far (foreground 7%). Schedule cards use tight.
  final bool tight;
