...
class OcOptical {
  ...
  /// plus title↔subtitle air. Wake-0037 tightened 52→46 toward README
  ...
  /// Official title/subtitle column is `gap-0.5` (2). Wake-0037 tightened
  /// 52→46 toward README session-row density without jumping to official
  /// 2. Do not re-widen. Do not touch project/schedule title↔meta 54.
  /// Do not pile another +2 — it re-kills start-align discs. Not a
