...
class OcOptical {
  ...
  /// has no Medium cut; 12px Regular AA-washes to ~RGB 135 (zero L<120
  /// cores at stem 1.0). One 2.0 same-color stem so mid-list p5 reaches
  /// dark ink. Not a 0.02 series. Device PingFang/Noto Medium is stronger.
